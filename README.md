...
| Document | Contents |
|----------|----------|
| [docs/design.md](docs/design.md) | Distribution decision and rationale, target architecture, installer requirements, the skill update policy, and delivery status |
